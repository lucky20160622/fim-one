...
<Tip>
**Local development:** SQLite works out of the box — no database server, no Redis, nothing to configure. Just start coding.

**Production:** Deploy with Docker Compose and PostgreSQL + Redis are provisioned automatically. No manual database setup needed.
</Tip>
