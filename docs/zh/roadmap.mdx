...
<div id="v01-2025-08-01-mvp-react-dag-planner">
  ### v0.1 (2025-08-01) — MVP：ReAct + DAG 规划器
</div>
...
<div id="v02-2025-09-15-multi-model-memory">
  ### v0.2 (2025-09-15) — 多模型 + 记忆
</div>
...
<div id="v03-2025-10-20-web-tools-mcp">
  ### v0.3 (2025-10-20) — 网页工具 + MCP
</div>
...
<div id="v04-2025-11-15-multi-turn-agents">
  ### v0.4 (2025-11-15) — 多轮对话 + 智能体
</div>
...
<div id="v05-2025-12-20-full-rag-grounded-gen">
  ### v0.5 (2025-12-20) — 完整 RAG + 可溯源生成
</div>
...
<div id="v06-2026-01-10-connector-platform">
  ### v0.6 (2026-01-10) — 连接器平台
</div>
...
<div id="v07-2026-02-07-admin-platform-multi-tenant">
  ### v0.7 (2026-02-07) — 管理平台 + 多租户
</div>
...
<div id="v07x-2026-02-21-onwards-stability-polish">
  ### v0.7.x (自 2026-02-21 起) — 稳定性与完善
</div>
...
| 语义记忆存储 | 上下文窗口持续扩大；提供商也在增加原生记忆能力 (ChatGPT Memory、Claude Projects) |
| 记忆生命周期 | 同上；随着差距不断缩小，相比之下工程成本偏高 |
