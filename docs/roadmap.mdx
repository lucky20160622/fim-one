...
- [x] **Workflow Phase 2 Nodes**: Iterator, Loop, VariableAggregator, ParameterExtractor, ListOperation, Transform, DocumentExtractor, QuestionUnderstanding — 8 advanced node types with full frontend + backend + 102 new tests (220 total). Stats panel with success rate bar. 6 built-in templates.
