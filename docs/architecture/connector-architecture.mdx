...
icon: "cable"
description: "How FIM One connects legacy systems through AI — from Copilot to Hub."
---
...
| What client has | How FIM One connects |
|---|---|
...
FIM One's MCP Client (shipped in v0.3) already supports third-party MCP Servers. Legacy system adapters are simply **domain-specific MCP Servers** built with the Connector Governance Layer for enterprise governance.
