...
import { Plus, Pencil, Trash2, Loader2, Brain, Zap, Info, Bot, Power, MoreHorizontal, ChevronDown, ChevronRight } from "lucide-react"
  ...
  useEffect(() => {
    if (open) {
      if (model) {
        ...
        setJsonModeEnabled(model.json_mode_enabled ?? true)
      } else {
        setName("")
        setProvider("")
        setModelName("")
              ...
              <div>
                ...
                {showOptional && (
                  <div className="mt-3 space-y-4">
                    <div className="space-y-1.5">
                      <Label htmlFor="am-base-url">{t("baseUrl")}</Label>
                      <Input
                        id="am-base-url"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1.5">
                        <Label htmlFor="am-max-output">{t("maxOutputTokens")}</Label>
                        <Input
                          id="am-max-output"
                          type="number"
                          placeholder="64000"
                      ...
                      <div className="space-y-1.5">
                        <Label htmlFor="am-context">{t("contextSize")}</Label>
                        <Input
                          id="am-context"
                          type="number"
                          placeholder="128000"
                    ...
                    <div className="flex items-start justify-between gap-3 rounded-md border p-3">
                      <div className="space-y-0.5 flex-1">
                        <Label htmlFor="am-json-mode" className="cursor-pointer">
                          {t("jsonModeEnabled")}
                        </Label>
                        <p className="text-xs text-muted-foreground leading-snug">
                          {t("jsonModeEnabledDesc")}
                        </p>
                      </div>
                      <Switch
                        id="am-json-mode"
