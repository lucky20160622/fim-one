...
```
  ...
  Planning    │  Camunda, Activiti  │  Salesforce Case    │
              │  Dify, n8n, Coze   │  (skeleton static,  │
              │  (human designs     │   branches dynamic) │
              │   graph at design   │                     │
              │   time)             │                     │
              ├─────────────────────┼─────────────────────┤
...
This places FIM Agent in the same quadrant as AutoGPT, but with engineering constraints that prevent runaway behavior. More flexible than BPM/Dify, more controlled than AutoGPT.
